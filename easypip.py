...
canvas1 = tk.Canvas(root, width = 200, height = 400, bg = '#FFD43B', relief = 'raised')
canvas1.pack()

label1 = tk.Label(root, text='easypip v1.2', bg = '#FFD43B')
...
button4 = tk.Button(text='      From Source     ', command=installFromSource, bg='#306998', fg='white', font=('helvetica', 12, 'bold'))
canvas1.create_window(100, 300, window=button4)
